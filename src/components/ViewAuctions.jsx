    ...
    return(
        <section className="bg-[#D7D6D8] py-[80px]">
            <div className="container grid grid-cols md:grid-cols-2 items-center gap-[80px]">
                ...
                <div>
                    <h2 className="text-[48px] text-black leading-[57px] font-[700] max-w-[460px]">VIEW THE JDM AUCTIONS</h2>
                    <p className="text-normal text-black font-[400] py-[24px] max-w-[460px]">Start Your Journey Today—Bring Home the JDM Car You’ve Always Dreamed Of</p>
