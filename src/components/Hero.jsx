            ...
            <div className="container grid grid-cols-1 md:grid-cols-2 gap-20 items-center justify-between pt-[110px] pb-[80px] px-6 relative z-10 my-10 animate__animated animate__fadeIn">
                ...
                <div className="hidden md:flex relative rounded-[20px] border-2 p-8 max-w-[522px] mx-auto overflow-hidden">
                    ...
                    <form className="pt-4">
                        ...
                        <div className="grid grid-cols ">
                            <button className="text-sm font-[400] block bg-transparent border boreder-[1px] border-white w-full outline-none text-white py-2 px-2 rounded-[8px] mt-[10px]">SUBMIT</button>
                        </div>
                    </form>
                </div>
                </div>
